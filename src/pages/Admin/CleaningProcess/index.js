    ...
    return (
        <div className="">
            ...
            <div className="box-teks border-bottom">
                <p className="t-h6">Process Cleaning</p>
            </div>
            <div className="box-transaction">
                <div className="address-border-bottom">
                    <p className="remove-btm t-transaction-main">Service<span className="t-status-transaction">Process Cleaning</span></p>
