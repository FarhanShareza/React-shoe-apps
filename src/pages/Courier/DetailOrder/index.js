    ...
    return (
        <div className="box-transaction-detail-main">
            ...
            <div className="box-transaction-status">
                ...
                <p className="remove-btm t-sub-transaction-main">Tanggal Pemesanan<span className="t-sub-right">23-Desember-2021</span></p>
            </div>
                    ...
                    <Row>
                        ...
                        <Col xs={10} sm={11} md={11}>
                            <div className="box-product-right">
                                <p className="t-price-transaction remove-btm">Deep Cleaning Shoes For Man</p>
                                <p className="t-price-transaction remove-btm">1 x <span>Rp 56000</span></p>
                            </div>
                        </Col>
                        <Col xs={2} sm={1} md={1}>
                            <div className="box-product-left rmv-padding">
            ...
            <div>
                <div className="box-btn-confirm">
                    <Button title="Konfirmasi Orderan"/>
                </div>
            
                <div className="box-btn-confirm">
                    <Button title="Hubungi Pelanggan"/>
                </div>
            </div>
            <Gap height={60}/>
        </div>
