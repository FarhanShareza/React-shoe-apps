...
import './orderPickup.scss'

const OrderPickup = () => {
    return (
        <div className="transaction-main">
            <div className="box-teks border-bottom">
                <p className="t-h6">Pick Up Order</p>
            </div>
            <div className="box-transaction">
                <div className="address-border-bottom">
                    <p className="remove-btm t-transaction-main">Service<span className="t-status-transaction">Penjemputan</span></p>
